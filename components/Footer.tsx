    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-bold mb-6 border-l-4 border-af-gold pl-3">Quick Links</h3>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-lg font-bold mb-6 border-l-4 border-af-gold pl-3">Contact Us</h3>
          ...
          {/* Map */}
          <div>
            <h3 className="text-lg font-bold mb-6 border-l-4 border-af-gold pl-3">Locate Us</h3>
