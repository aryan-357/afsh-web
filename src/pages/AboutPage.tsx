...
const AboutPage: React.FC = () => {
    return (
        <div className="bg-white dark:bg-gray-900 transition-colors duration-300">
            ...
            <div id="ed-message" className="border-b border-gray-50 dark:border-gray-800" style={{ contentVisibility: 'auto', containIntrinsicSize: '0 800px' }}>
                <EDMessage />
            </div>

            {/* Principal's Message Section */}
            <Suspense fallback={<div>Loading principal message...</div>}>
                <div id="principal" className="border-b border-gray-50 dark:border-gray-800" style={{ contentVisibility: 'auto', containIntrinsicSize: '0 800px' }}>
                    <PrincipalMessage />
                </div>
            </Suspense>
            ...
            {/* PGT Teachers */}
            <div className="py-12 bg-gradient-to-b from-blue-50/50 to-white dark:from-blue-900/10 dark:to-gray-900" style={{ contentVisibility: 'auto', containIntrinsicSize: '0 600px' }}>
                <div className="container mx-auto px-6 mb-8">
                    <h3 className="text-2xl font-serif font-bold text-af-blue dark:text-blue-400 uppercase tracking-widest flex items-center gap-3">
                        <span className="w-8 h-1 bg-af-blue rounded-full"></span>
                        PGT Teachers
                    </h3>
                </div>
            ...
            {/* TGT Teachers */}
            <div className="py-12 bg-gradient-to-b from-amber-50/50 to-white dark:from-amber-900/10 dark:to-gray-900" style={{ contentVisibility: 'auto', containIntrinsicSize: '0 600px' }}>
                <div className="container mx-auto px-6 mb-8">
                    <h3 className="text-2xl font-serif font-bold text-amber-600 dark:text-amber-400 uppercase tracking-widest flex items-center gap-3">
            ...
            {/* PRT Teachers */}
            <div className="py-12 bg-gradient-to-b from-indigo-50/50 to-white dark:from-indigo-900/10 dark:to-gray-900" style={{ contentVisibility: 'auto', containIntrinsicSize: '0 600px' }}>
                <div className="container mx-auto px-6 mb-8">
                    <h3 className="text-2xl font-serif font-bold text-indigo-600 dark:text-indigo-400 uppercase tracking-widest flex items-center gap-3">
            ...
            <section id="admin" className="py-24 bg-gray-900 text-white">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
                        {[
                            { icon: Shield, title: 'Integrity', desc: 'Upholding honesty in all actions.', color: 'text-blue-400', bg: 'bg-blue-400/10' },
                            { icon: Award, title: 'Excellence', desc: 'Striving for the best results.', color: 'text-af-gold', bg: 'bg-af-gold/10' },
                            { icon: BookOpen, title: 'Innovation', desc: 'Creative approaches to learning.', color: 'text-emerald-400', bg: 'bg-emerald-400/10' },
                            { icon: Heart, title: 'Compassion', desc: 'Empathy for every student.', color: 'text-rose-400', bg: 'bg-rose-400/10' },
                        ].map((value, idx) => (
                            <div key={idx} className="group p-6 hover:bg-white/5 rounded-3xl transition-all duration-500">
                                <div className={`w-20 h-20 mx-auto mb-6 flex items-center justify-center rounded-2xl ${value.bg} group-hover:scale-110 transition-all duration-500`}>
